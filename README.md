...
1. Research problem using dir name on platforms like leetcode
2. Attempt the problem yourself first
3. Review the solution code
4. Focus on understanding the *pattern*, not just the answer
5. Reapply the pattern to similar problems
